...
MESSAGES = {
    ...
    'no_active_orders': 'У вас нет заказов на завтра.',
    'active_orders_separator': '➖➖➖➖➖➖➖➖➖➖\n',
    'total_sum': '💰 *Итого к оплате: {sum} р\\.*',
    ...
    'wrong_order_time': 'Извините, но заказы принимаются только с 10:00 до 00:00. Если у вас есть вопросы, вы можете нажать кнопку "Задать вопрос"',
    ...
    'payment_expired': 'Время действия QR-кода истекло (10 минут). Сгенерируйте новый QR-код для оплаты.',
    'payment_status_check': '⏳ Проверяем статус оплаты...',
    'payment_waiting': 'Ожидаем подтверждение оплаты...',
    'pay_message': 'Вы можете оплатить заказы через СБП'
}
...
BUTTONS = {
    ...
    'edit_active_orders': '✏️ Изменить заказы на завтра',
    'cancel_order': '❌ Отменить заказ',
    'my_orders': '🧾 Мои заказы',
    'today_orders': '📅 Заказы на сегодня',
    ...
    'orders_to_pay': '💰 Заказы на оплату',
